...
# Plot 3: Probability that Variant is better over time
...
```{python}
# Plot 4: Expected loss over time
...
(ggplot(loss_data, aes(x='day', y='expected_loss')) +
         ...
         labs(x='Day', y='Expected Loss',
              title='Expected Loss if Choosing Variant') +
         theme_minimal())
```
...
```python
#| echo: false
# Plot 2: Credible intervals over time
