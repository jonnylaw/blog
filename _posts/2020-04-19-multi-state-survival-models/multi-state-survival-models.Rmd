...
```{r multi-state, echo=FALSE, eval=FALSE, engine='tikz', out.width='90%', fig.ext='png'}
...
![state transition diagram](/blog/multi-state-survival-models_files/multi-state-1.png)
...
write_rds(iters, path = here::here("models/ctmc.Rds"))
```

```{r read-iters, eval=!run_mcmc}
iters <- read_rds(here::here("models/ctmc.Rds"))
```
