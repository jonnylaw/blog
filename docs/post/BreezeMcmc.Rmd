...
library(tidyverse); library(gridExtra); library(coda); library(ggmcmc)
...
data = read_csv("~/Documents/blog/breeze/data/BivariateSimulated.csv", col_names = c("x", "y"))
...
parameters = read_csv("~/Documents/blog/breeze/data/Parameters.csv", col_names = c("mu_1", "mu_2", "sigma"))
