...
A [Metropolis](https://en.wikipedia.org/wiki/Metropolis–Hastings_algorithm) algorithm can be used to determine the posterior distribution of the parameters, $\mu$ and $\Sigma$.
...
The relative speedup is plotted below, the C++ algorithm appears to be around 130 times faster to generate 100 correlated samples from the posterior distribution.
