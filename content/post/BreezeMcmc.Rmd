...
data = read_csv("../../scala_projects/breeze/data/BivariateSimulated.csv", col_names = c("x", "y"))
...
parameters = read_csv("../../scala_projects/breeze/data/Parameters.csv", col_names = c("mu_1", "mu_2", "sigma"))
