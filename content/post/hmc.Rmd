...
write_rds(hmc_time, "~/git/blog/static/models/hmc_time.Rds")
```

```{r, echo=FALSE}
out_hmc <- read_rds("~/git/blog/static/models/hmc_bivariate.Rds")
hmc_time <- read_rds("~/git/blog/static/models/hmc_time.Rds")
```
...
write_rds(metropolis_time, "~/git/blog/static/models/metropolis_timing.Rds")
```


```{r, echo=FALSE}
out_met <- read_rds(path = "~/git/blog/static/models/metropolis_parallel.Rds")
metropolis_time <- read_rds("~/git/blog/static/models/metropolis_timing.Rds")
```
