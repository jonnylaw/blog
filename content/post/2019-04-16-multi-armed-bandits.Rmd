...
Now to see the behaviour of a typical multi-armed bandit with an approximately constant reward function, calculate the average reward for n = 2,000 10-arm bandits each with 1,000 steps.
