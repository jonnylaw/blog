...
Different values of epsilon can be compared and the average reward calculated

```scala
val data = List(0.0, 0.1, 0.5).map ( eps => averageReward(2000, 1000, eps))
```

<img src="/post/2019-04-16-multi-armed-bandits_files/average_reward_eps.png" alt="actions distribution" width=500 />