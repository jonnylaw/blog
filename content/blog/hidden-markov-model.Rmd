...
```{r hmm, echo=FALSE, eval=FALSE, engine='tikz', out.width='90%', fig.ext='png'}
...
readr::write_rds(iters_metropolis, path = here::here("models/metropolis-hmm.Rds"))
```

```{r read-iters-cpp, eval=!run_mcmc}
iters_metropolis <- readr::read_rds(here::here("models/metropolis-hmm.Rds"))
```
