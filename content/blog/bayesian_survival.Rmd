...
readr::write_rds(fit_exponential, here::here("models/brms_survival.Rds"))
```

```{r read-iters, eval=!run_mcmc}
fit_exponential <- readr::read_rds(fit_exponential, here::here("models/brms_survival.Rds"))
```
