...
```{r write-iters-hmc, eval=write_mcmc}
readr::write_rds(hmc_time, path = here::here("models/hmc-time.Rds"))
readr::write_rds(out_hmc, path = here::here("models/hmc.Rds"))
```

```{r read-iters-hmc, eval=!run_mcmc}
hmc_time <- readr::read_rds(here::here("models/hmc-time.Rds"))
out_hmc <- readr::read_rds(here::here("models/hmc.Rds"))
```
...
```{r write-iters-metropolis, eval=write_mcmc}
readr::write_rds(metropolis_time, path = here::here("models/metropolis-time.Rds"))
```

```{r read-iters-metropolis, eval=!run_mcmc}
metropolis_time <- readr::read_rds(here::here("models/metropolis-time.Rds"))
out_met <- readr::read_rds(here::here("models/metropolis-r.Rds"))
```
